...
{
    public class GestaoIntermodalController : ModuloBaseController<MLModuloAgendamentoIntermodalEdicao, MLModuloAgendamentoIntermodalHistorico, MLModuloAgendamentoIntermodalPublicado>
    {
        #region Index
        ...
        public override ActionResult Index(decimal? codigoPagina, int? repositorio)
        {
            try
            {
                ...
                var model = CRUD.Obter(new MLModuloAgendamentoIntermodalPublicado { CodigoPagina = codigoPagina, Repositorio = repositorio }, portal.ConnectionString);
                if (model == null) model = new MLModuloAgendamentoIntermodalPublicado();
        ...
        public override ActionResult Visualizar(decimal? codigoPagina, int? repositorio, bool? edicao, string codigoHistorico)
        {
            try
            {
                ...
                if (model == null)
                {
                    var modelEdicao = new MLModuloAgendamentoIntermodalEdicao
                    {
                        CodigoPagina = codigoPagina,
                        Repositorio = repositorio,
                        UrlExportacao = "Padrao",
                        UrlImportacao = "Padrao",
                        DataRegistro = DateTime.Now,
                        CodigoUsuario = BLUsuario.ObterLogado().Codigo
                    };

                    CRUD.Salvar<MLModuloAgendamentoIntermodalEdicao>(modelEdicao, portal.ConnectionString);
        ...
        //            var propriedades = CRUD.Obter(new MLModuloAgendamentoIntermodalPublicado { CodigoPagina = codigoPagina, Repositorio = repositorio }, portal.ConnectionString);
        ...
        //            {
        //                propriedades = new MLModuloAgendamentoIntermodalPublicado();
        ...
        //[CheckPermission(global::Permissao.Publico)]
        //public ActionResult Renderizar(MLModuloAgendamentoIntermodal model)
        //{
