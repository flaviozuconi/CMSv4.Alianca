...
fileTypeIcons['xlsx'] = 'file_extension_xlsx.png';
...
function File(filePath, fileSize, modTime, w, h) {
    ...
    this.Show = function () {
        ...
        html += '<img src="' + this.icon + '" class="icon lazyload">';
...
function tooltipContent() {
    ...
    if ($('#hdViewType').val() == 'thumb' && f.IsImage()) {
        html = f.fullPath + '<br><span class="filesize">' + t('Size') + ': ' + RoxyUtils.FormatFileSize(f.size) + ' </span>';
    }
    else if (f.IsImage()) {
        if (RoxyFilemanConf.GENERATETHUMB) {
            ...
            imgUrl = f.fullPath;
        html = '<img src="' + imgUrl + '" class="imgPreview"><br>' + f.name + ' <br><span class="filesize">' + t('Size') + ': ' + RoxyUtils.FormatFileSize(f.size) + ' </span>';
    }
    else
...
function switchView(t) {
    ...
    if (t == 'thumb') {
        ...
        $('#pnlFileList li').each(function () {
            ...
            $(this).children('.icon').addClass('lazyload').attr('data-src', location + "/Content/js/plugins/ckeditor/plugins/fileman/" + imgUrl);//.css('background-image', 'url('+imgUrl+')');
        ...
        $('#pnlFileList li').each(function () {
            $(this).children('.icon').removeClass('lazyload').attr('src', $(this).attr('data-icon'));
